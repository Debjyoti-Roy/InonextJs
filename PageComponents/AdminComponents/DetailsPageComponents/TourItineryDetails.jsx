...
const TourItenaryDetails = ({ carPackageDetails, itenaryClose }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const payload = {
                packageId: carPackageDetails.id,
            };

            // console.log("Helloooooo   ",carPackageDetails)
            ...
            for (let i = 0; i < itineraries.length; i++) {
                ...
                if (hasChanged) {
                    itinerariesWithUrls.push({
                        ...
                        dayNumber:originalIt?.dayNumber
                    });
                } else {
            ...
            // Call API
            dispatch(updateTourPackage({ formData: payload }))
                .unwrap()
                .then((res) => {
                    setSubmitting(false);
...
export default TourItenaryDetails