...
import ManageProperties from '@/PageComponents/PartnerDashboardComponents/ManageProperties';
import AddRoom from '@/PageComponents/PartnerDashboardComponents/AddRoom';
import PropertyDashboard from '@/PageComponents/PartnerDashboardComponents/PropertyDashboard';
import { useDispatch, useSelector } from 'react-redux';
import { getHotels } from '@/Redux/store/hotelSlice';
import HotelAnalytics from '@/PageComponents/PartnerDashboardComponents/HotelAnalytics';
import { getCars } from '@/Redux/store/partnerCar';
import AddCar from '@/PageComponents/PartnerDashboardComponents/AddCar';
import CarList from '@/PageComponents/PartnerDashboardComponents/CarList';
...
const PartnerDashboard = () => {
  ...
  const { cars } = useSelector((state) => state.partnerCar);
  useEffect(() => {
