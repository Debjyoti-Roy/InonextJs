...
import { QueryStatus } from "@/PageComponents/ProfileComponents/statusEnum";
import Image from "next/image";

const getInitialUserData = () => {
  if (typeof window === "undefined") return {}; // Handle SSR safety
  try {
...
const Profile = () => {
  const [profileData, setProfileData] = useState(getInitialUserData);
  const [isEditing, setIsEditing] = useState(false);
  const [inputValue, setInputValue] = useState(() => profileData.name || "");
